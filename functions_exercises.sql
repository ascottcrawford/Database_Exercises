...
SELECT COUNT(last_name) as COUNT, CONCAT(first_name, ' ', last_name) as full_name FROM employees WHERE last_name LIKE '%q%' AND NOT last_name LIKE '%qu%' GROUP BY full_name ORDER BY COUNT DESC;
